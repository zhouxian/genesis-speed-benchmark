...
# Load franka asset
asset_root = "../../assets/"
franka_asset_file = "urdf/go2/urdf/go2.urdf"
...
gym.prepare_sim(sim)
pos_action = gymtorch.unwrap_tensor(default_qpos)
...
def step():
    ...
    if random_action:
        pos_action = gymtorch.unwrap_tensor(default_qpos + torch.rand((n_envs, 12), device='cuda')*0.4 - 0.2)
        gym.set_dof_position_target_tensor(sim, pos_action)
